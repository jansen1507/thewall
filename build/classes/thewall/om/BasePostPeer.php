 ...
 *
 *
 * @package propel.generator.thewall.om
 */
abstract class BasePostPeer
{

    /** the default database name for this class */
    const DATABASE_NAME = 'thewall';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Text', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'text', ),
        BasePeer::TYPE_COLNAME => array (PostPeer::ID, PostPeer::TEXT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TEXT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'text', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Text' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'text' => 1, ),
        BasePeer::TYPE_COLNAME => array (PostPeer::ID => 0, PostPeer::TEXT => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TEXT' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'text' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
