    ...
    <div class="row">
        ...
        <nav class="ten columns navbar">
            <ul id="main-menu">
                ...
                <?php if(Helpers\Auth::check()): ?>
                    <span style="color:white;font-size:14px;">Logged in as: <span style="font-weight: bolder;"><?php echo Helpers\Sanitizor::escapeHTML(UserQuery::create()->filterById(Helpers\Session::get('user_id'))->findOne()->getUsername()); ?><?php echo (Helpers\Auth::isAdmin() ? '<span style="font-weight:lighter;">(admin)</span>' : ''); ?></span></span>
